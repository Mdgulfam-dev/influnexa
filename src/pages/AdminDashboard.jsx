...
export default function AdminDashboard() {
  ...
  const updateCandidateStatus = async (id, nextStatus) => { try { await updateJobApplicationStatus(id, nextStatus); await loadDashboard(); } catch (error) { setStatus({ type: "error", message: error.message }); } };
